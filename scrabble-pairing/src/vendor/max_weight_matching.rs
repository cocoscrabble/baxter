// Vendored verbatim from rustworkx-core 0.18.0
// (https://github.com/Qiskit/rustworkx, src/max_weight_matching.rs) so the
// crate's matching path has no rayon/getrandom dependency and stays
// wasm-compatible. Only the `use crate::dictmap` import below was changed to
// `use super::dictmap` to fit this crate's module layout. See ATTRIBUTION.md.
//
...
///
/// # Example
/// (Illustrative; uses the upstream rustworkx-core paths. This crate calls the
/// function through `crate::matching` instead.)
/// ```ignore
