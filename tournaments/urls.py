...
urlpatterns = [
    ...
    path("division/<int:pk>/publish-round/", PublishRoundView.as_view(), name="publish_round"),
    ...
    path("division/<int:pk>/scorecards/download/", DivisionScorecardsDownloadView.as_view(), name="division_scorecards_download"),
    ...
    path("division/<int:pk>/rename/", DivisionRenameView.as_view(), name="division_rename"),
    ...
    path("division/<int:pk>/fixtures/", DivisionFixturesEditView.as_view(), name="division_fixtures"),
    path("division/<int:pk>/round-pairings/", DivisionRoundPairingsEditView.as_view(), name="division_round_pairings"),
    path("division/<int:pk>/round-pairings/preview/", DivisionRoundPairingsPreviewView.as_view(), name="division_round_pairings_preview"),
    path("division/<int:pk>/bulk-import/", BulkImportEntrantsView.as_view(), name="bulk_import_entrants"),
    path("division/<int:pk>/presence/<str:scope>/", EditPresenceView.as_view(), name="edit_presence"),
